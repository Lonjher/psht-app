            ...
            <View className="mt-4 rounded-2xl border border-stone-200 bg-white p-5 shadow-sm shadow-stone-300 dark:border-stone-800 dark:bg-stone-900 dark:shadow-none">
              ...
              <TouchableOpacity
                ...
                <View className="flex-row items-center justify-between">
                  <Text
                    className={`text-sm ${form.tanggal_kenaikan
              ...
              {form.rataRata !== null && form.rataRata !== undefined && (
                <View
                  className={`mb-3 rounded-lg p-3 ${form.rataRata < 60
                      ? 'bg-red-50 dark:bg-red-950/30'
                      : 'bg-green-50 dark:bg-green-950/30'
                    }`}>
                  <Text
                    className={`text-sm font-bold ${form.rataRata < 60
                  ...
                  <Text
                    className={`mt-1 text-xs ${form.rataRata < 60
